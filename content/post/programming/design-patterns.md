...
一个设计模式学习网站 [http://java-design-patterns.com/](http://java-design-patterns.com/). 截至 2018 年5 月份，这个 repo 在 github 的 stars 已超过 10,900+. 这个 repo 涉及的设计模式已经远远超出了 GOF 的 23 种设计模式。当然，本来设计模式就远不止这 23 种。
